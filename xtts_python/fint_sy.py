...
# Logging parameters
RUN_NAME = "GPT_XTTS_v2.0_BBANGHYONG_FT_SY"
...
workspac = Path("/dev/hdd/user/kjy/ict/dataset_sy/datasets")
metadata = Path("/dev/hdd/user/kjy/ict/dataset_sy/datasets/txt/text.txt")
...
SPEAKER_REFERENCE = [
    "/dev/hdd/user/kjy/ict/dataset_sy/datasets/wavs/204.wav"  # speaker reference to be used in training test sentences
]
