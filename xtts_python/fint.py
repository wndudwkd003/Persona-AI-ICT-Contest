...
# Logging parameters
RUN_NAME = "GPT_XTTS_v2.0_BBANGHYONG_FT_JY"
...
workspac = Path("/dev/hdd/user/kjy/ict/datasets/preprocess/[인공지능] 2. History of AI, Intelligent Agents_A반/contents")
metadata = Path("/dev/hdd/user/kjy/ict/datasets/preprocess/[인공지능] 2. History of AI, Intelligent Agents_A반/contents/metadata.txt")
config_dataset = BaseDatasetConfig(
    formatter="ljspeech",
    dataset_name="my_ict_dataset",
    path=workspac,
...
SPEAKER_REFERENCE = [
    "/dev/hdd/user/kjy/ict/datasets/[인공지능] 2. History of AI, Intelligent Agents_A반.wav"  # speaker reference to be used in training test sentences
]
