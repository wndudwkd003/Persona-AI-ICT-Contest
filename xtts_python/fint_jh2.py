...
# Logging parameters
RUN_NAME = "GPT_XTTS_v2.0_BBANGHYONG_FT_JH2"
...
workspac = Path("/dev/hdd/user/kjy/ict/dataset_jh2/datasets")
metadata = Path("/dev/hdd/user/kjy/ict/dataset_jh2/datasets/txt/text.txt")
...
SPEAKER_REFERENCE = [
    "/dev/hdd/user/kjy/ict/dataset_jh2/datasets/wavs/6.wav"  # speaker reference to be used in training test sentences
]
