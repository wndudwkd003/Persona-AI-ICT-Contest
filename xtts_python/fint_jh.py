...
# Logging parameters
RUN_NAME = "GPT_XTTS_v2.0_BBANGHYONG_FT_JH"
...
workspac = Path("/dev/hdd/user/kjy/ict/dataset_jh/contents")
metadata = Path("/dev/hdd/user/kjy/ict/dataset_jh/자막.csv")
...
SPEAKER_REFERENCE = [
    "/dev/hdd/user/kjy/ict/dataset_jh/contents/wavs/84.wav"  # speaker reference to be used in training test sentences
]
