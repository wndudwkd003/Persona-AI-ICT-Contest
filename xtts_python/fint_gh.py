...
# Logging parameters
RUN_NAME = "GPT_XTTS_v2.0_BBANGHYONG_FT_GH"
...
workspac = Path("/dev/hdd/user/kjy/ict/dataset_gh/datasets")
metadata = Path("/dev/hdd/user/kjy/ict/dataset_gh/datasets/TextData/output_combined.txt")
...
SPEAKER_REFERENCE = [
    "dataset_gh/datasets/speaker.wav"  # speaker reference to be used in training test sentences
]
